...
class ProductTypeServiceTest extends Specification {
    ...
    UpdaterService productTypeUpdateService = Mock()
    ...
    def setup() {
        ...
        entity = ProductTypeMapper.toEntity(draft)
        entity.id = id
    }
    ...
    def "test 4.3 : query ProductType by QueryConditions"() {
        ...
        List<ProductType> entities = Lists.newArrayList(entity)
