...
public final class ProductTypeActionUtils {
   ...
   */
  public static final String ADD_ATTRIBUTE_DEFINITION =
      PRODUCT_TYPE_ROOT + "add_attribute_definition";

  /**
   * The constant remove_attribute_definition.
   */
  public static final String REMOVE_ATTRIBUTE_DEFINITION =
      PRODUCT_TYPE_ROOT + "remove_attribute_definition";

  /**
   * The constant SET_ATTRIBUTE_DEFINITION_LABEL.
   */
  public static final String SET_ATTRIBUTE_DEFINITION_LABEL =
      PRODUCT_TYPE_ROOT + "set_attribute_label";

  /**
   * The constant set_attribute_definition_inputtip.
   */
  public static final String SET_ATTRIBUTE_DEFINITION_INPUTTIP =
      PRODUCT_TYPE_ROOT + "set_attribute_definition_inputtip";
   ...
   */
  public static final String ADD_LOCALIZED_ENUM_VALUE =
      PRODUCT_TYPE_ROOT + "add_localized_enum_value";
   ...
   */
  public static final String SET_LOCALIZED_ENUM_VALUE_ORDER =
      PRODUCT_TYPE_ROOT + "set_localized_enum_value_order";
   ...
   */
  public static final String SET_LOCALIZED_ENUM_VALUE_LABEL =
      PRODUCT_TYPE_ROOT + "set_localized_enum_value_label";

  /**
   * The constant set_attribute_definition_is_searchable.
   */
  public static final String SET_ATTRIBUTE_SEARCHABLE =
      PRODUCT_TYPE_ROOT + "set_attribute_searchable";
